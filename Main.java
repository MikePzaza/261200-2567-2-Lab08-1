...
public class Main {
    public static void main(String[] args) {
       ...
       // ใน ตอนเริ่ม thread จะพิมพ์เลข 1-50 และมีการดีเลย์แบบสุ่มเพื่อจำลองการทำงานของ thread หลายตัวพร้อมกัน
       // เเละจะเห็นว่าตัวเลขจากแต่ละเธรดจะพิมพ์สลับกันไปมา เพราะเป็นการทำงานแบบมัลติ thread
